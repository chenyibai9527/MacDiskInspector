...
## 2026-07-27 更新日志版本边界修复

- 以 GitHub Releases 与 tag 为准确认当前最新公开版本是 `v0.2.3-preview.2`；`preview.3` 尚未发布，`.2` 之后的提交仍属于“未发布”。
- 将深色标题栏融合、统一发布链和历史日志补齐归入 `0.2.3-preview.2`，把 Node.js 24 与本地构建注销保留在“未发布”。
- 发布标签校验新增对应 `CHANGELOG.md` 版本章节要求，避免今后先发布 Release、后发现更新日志仍停留在旧版本。
